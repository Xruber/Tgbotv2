...
def main():
    ...
    # ---------------------------------------------------------
    # IMPORTANT: Handler Order determines Priority!
    # 1. Buying (Highest Priority to catch UTR)
    # 2. Target Game (To catch game buttons)
    # 3. Prediction (Lowest Priority, generic text filter)
    # ---------------------------------------------------------

    # 1. BUY HANDLER (Highest Priority)
    ...
    # 3. PREDICTION HANDLER (Lowest Priority)
