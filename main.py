...
# Added check_and_reset_monthly_stats to imports
...
async def invite_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"Each sales gain ₹100 in upi. Please DM @GAINEO to claim at end of the month"
...
async def monthly_reset_job(context: ContextTypes.DEFAULT_TYPE):
    """Checks periodically if it's a new month and resets stats."""
    try:
...
def main():
    ...
    # Add Monthly Check Job (Runs every 1 hour)
