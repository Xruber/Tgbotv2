...
# FIND the 'switch_command' function in main.py and replace it with this:
...
async def switch_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"⚙️ **Prediction Engine Switcher**\n\n"
        f"**Current Engine:** {curr}\n\n"
        "**V1:** 6 Patterns + Follow Winner\n"
        "**V2:** Aggressive Streak\n"
        "**V3:** Pure Randomness\n"
        "**V4:** Trend Follow + Lvl 4 Safety", 
        reply_markup=kb,
        parse_mode="Markdown"
    )
