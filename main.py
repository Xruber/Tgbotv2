...
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "Use /reset to clear history and restart levels.",
...
async def reset_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # 2. Reset Prediction to a fresh random start
    ...
    await update.message.reply_text(
        ...
        "• Level reset to **1**\n"
        "• Pattern History **Deleted**\n"
        "• Next prediction is ready.\n\n"
        "Use /start to continue playing.",
        parse_mode="Markdown"
    )
...
def main():
    ...
    app.add_handler(CommandHandler("reset", reset_command)) # ADDED
