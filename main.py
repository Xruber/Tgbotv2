...
def main():
    ...
    # 3. HANDLERS WITH FIX: /start and /cancel force-quit any mode
    
    # BUY HANDLER (Highest Priority)
    buy_h = ConversationHandler(
        ...
        fallbacks=[CommandHandler("cancel", cancel), CommandHandler("start", start_command)], # ADDED START
        allow_reentry=True
    )
    ...
    # PREDICTION HANDLER (Lowest Priority)
