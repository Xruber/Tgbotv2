...
tokens_collection = None  # <--- NEW: Added Token Collection
...
try:
    ...
    tokens_collection = db.tokens # <--- NEW: Connected to DB
    logger.info("✅ Successfully connected to MongoDB.")
except Exception as e:
    logger.error(f"❌ Failed to connect to MongoDB: {e}")

# --- NEW: TOKEN SYSTEM INITIALIZATION ---
INITIAL_TOKENS = [
...
# --- NEW: TRANSACTION HISTORY SYSTEM ---
