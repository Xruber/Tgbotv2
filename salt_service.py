...
# This allows main.py to read the latest results without stopping the thread
LATEST_RESULTS = {
    "30s": {"salt": "Scanning...", "acc": 0, "last_update": "Pending"},
    "1m": {"salt": "Scanning...", "acc": 0, "last_update": "Pending"}
}
...
class SaltCrackerWorker(threading.Thread):
    ...
    def notify_admin(self, salt, wins, total):
        ...
        # UPDATE GLOBAL VARIABLE FOR ADMIN PANEL
        ...
        # Optional: Send DM (Can comment this out if you only want the panel)
        msg = (
